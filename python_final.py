...
# prompt: display the previous graph, relabeling statistics.rank as "Skyscraper Rank" and statistics.height as "Skyscraper Height"

import pandas as pd
# Assuming the dataframe 'df' and the plot already exist from the previous code

df = df.rename(columns={"statistics.rank": "Skyscraper Rank", "statistics.height": "Skyscraper Height"})
df[["Skyscraper Rank", "Skyscraper Height"]].plot.line(x="Skyscraper Rank", y="Skyscraper Height")
...
def get_city_and_height(row):
    ...
    return row['location.city'], row['Skyscraper Height']
